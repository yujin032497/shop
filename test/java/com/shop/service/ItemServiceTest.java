...
public class ItemServiceTest {
    ...
    List<MultipartFile> createMultipartFiles() throws Exception { // 가짜 MultipartFile 리스트를 만들어서 반환해주는 메소드
    ...
    void saveItem() throws Exception {
        ...
        Long itemId = itemService.saveItem(itemFormDto, multipartFileList); // 상품 데이터와 이미지 정보를 파라미터로 넘겨서 저장 후
