...
public class ItemFormDto {
    ...
    private List<Long> itemImgIds = new ArrayList<>(); // 상품의 이미지 아이디를 저장하는 리스트
                                                       ...
                                                       // 아무 값도 들어가 있지 ㅇ낳고 수정 시에 이미지 아이디를 담아둘 용도로 사용

    private static ModelMapper modelMapper = new ModelMapper(); // 엔티티 객체와 DTO 객체 간의 데이터를 복사하여

    public Item createitem() {
        return modelMapper.map(this, Item.class); // 복사한 객체를 반환
    }
